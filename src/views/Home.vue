<template>
  <div class="home">
    <el-form :model="form" :rules="rules" ref="form" label-position="right" label-width="200px">
      <el-form-item label="中文js文件" prop="filePath">
        <el-input v-model="form.filePath" placeholder="请选择js文件">
          <el-button slot="append">
            <label for="filePath">浏览</label>
            <input
              type="file"
              id="filePath"
              style="display: none;"
      ...
      <el-form-item label="翻译文js文件" prop="enJsPath">
        <div slot="label">
          翻译文js
          <el-tooltip class="item" effect="dark" content="如：en.js, 用于提取增量" placement="top">
            <i class="el-icon-question"></i>
          </el-tooltip>
        </div>
        <el-input v-model="form.enJsPath" placeholder="请选择js文件">
          <el-button slot="append">
            <label for="enJsPath">浏览</label>
            <input
              type="file"
              id="enJsPath"
              style="display: none;"
              accept=".js"
              @change="e => getFilePath(e, 'enJsPath')"
            />
          </el-button>
        </el-input>
      </el-form-item>
      ...
      <el-form-item>
        <el-button type="primary" @click="onSubmit">提取增量</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
